...
const es: Translations = {
  ...
  plan: {
    ...
    packing: {
      ...
      details: {
        open: "Leo lo que pides.",
        list: "Fechas, viajeros y lo que buscas.",
        wardrobe: "Sitios que encajan con el viaje.",
        fold: "Monto cada día.",
        weigh: "Compruebo que nada pese de más.",
        zip: "Ya casi está.",
      },
      ...
      tag: {
        title: "Etiqueta de equipaje",
        heading: "Antes de cerrar la maleta",
        missing: "me faltan {count} datos",
        missingOne: "me falta un dato",
        toDecide: "Por decidir",
        budget: "Presupuesto",
      },
      suitcase: {
        label: "La maleta mientras se hace",
        list: "La lista",
        wardrobe: "Del armario",
        options: "Lo que miro",
        day: "Día {day}",
        weight: "Peso",
        unweighed: "Sin pesar",
        withinLimits: "Dentro de lo previsto",
      ...
      lost: {
        ...
        safe: "Tu viaje sigue como estaba.",
        retry: "Reintentar",
      },
      stickers: {
        overloaded_day: "Sobrepeso",
        too_far: "Lejos",
        closed: "Cerrado",
    ...
    panel: {
      ...
      savePastDates: "Esas fechas ya pasaron: elige fechas a partir de mañana para guardar el viaje.",
      saving: "Guardando",
      saved: "Guardado",
