...
├── hooks/          # admin/ (useAdminStats, useTurns, useTurn, useAdminUsers, useAdminTrips, useAdminTrip, useSessionTurns), useTrips, useTrip, useSaveTrip, useTypewriter, useFormatters, useStickToBottom, useAutoResizeTextarea, useScrolled, useClickOutside
...
the keyboard path. `e2e/admin-trip.spec.ts` (TRA-229) does the same for the trip page: header,
