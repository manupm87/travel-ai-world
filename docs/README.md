...
| Where | What |
|---|---|
| [architecture/overview.md](architecture/overview.md) | System diagram, request flows, service boundaries, [AWS target diagram](architecture/aws-architecture.png) (source in [architecture/diagrams/](architecture/diagrams/), `just diagrams`) |
