...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col bg-[#0A0A12] pt-[72px]">
      <div className="max-w-[1440px] mx-auto px-16 pt-20 pb-16 flex flex-col gap-10">
        {/* Badge */}
        ...
        {/* Headline */}
        <h1 className="text-[72px] xl:text-[88px] font-bold text-white leading-[1.0] tracking-[-2px] max-w-4xl">
          Your Dream Trip,
          <br />
          Designed by AI.
        </h1>
        ...
        <p className="text-xl text-[#8888AA] leading-relaxed max-w-[640px]">
          Tell us where you want to go, your budget, and your travel style. Our
          AI crafts a personalized, day-by-day itinerary built just for you —
          in seconds.
        </p>
        ...
        <div className="flex flex-wrap items-center gap-4">
          <Link
            href="#planner"
            className="bg-[#4F6EF7] hover:bg-[#3B5BDB] transition-all duration-200 text-white font-bold text-base px-9 py-4 rounded-lg shadow-lg shadow-[#4F6EF740] hover:shadow-[#4F6EF760]"
          >
            Plan My Trip Free
          </Link>
          <Link
        ...
        <div className="flex flex-wrap gap-8">
          <span className="text-sm text-[#8888AA]">✓ No credit card required</span>
          <span className="text-sm text-[#8888AA]">✓ 50,000+ trips planned</span>
          <span className="text-sm text-[#8888AA]">✓ 190+ destinations</span>
        </div>
